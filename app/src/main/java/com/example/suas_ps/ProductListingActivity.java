...
public class ProductListingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(view1 -> {
            ...
            mDatabaseForProductUploading = FirebaseDatabase.getInstance().getReference().child("product_listing");
    ...
    private void uploadDataToDatabase() {
        ...
        mDatabaseForProductUploading.child(roomEditText.getText().toString()).updateChildren(Data).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                Toasty.success(ProductListingActivity.this, "Product Submitted Successfully", Toast.LENGTH_LONG, true).show();
