...
public class EventRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(view1 -> {
            ...
            mDatabaseForProductUploading = FirebaseDatabase.getInstance().getReference().child("event_request");
    ...
    private void uploadDataToDatabase() {
        ...
        mDatabaseForProductUploading.child(roomEditText.getText().toString()).updateChildren(Data).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                Toasty.success(EventRequestActivity.this, "Request Submitted Successfully", Toast.LENGTH_LONG, true).show();
